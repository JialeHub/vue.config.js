<template>
  <div id="students_number_subjects_2_3_school">
      ...
      <div class="filterToolbar" v-show="filterToolbar">
        ...
        <v-menu v-model="FilterMenuSearchDate" :close-on-content-click="false" transition="scale-transition" offset-y
          ...
          <template v-slot:activator="{ on, attrs }">
            <v-text-field label="科二科三在学时间范围" style="flex: 0 1 290px" outlined dense readonly hide-details
        ...
        <v-btn depressed color="warning" @click="commitOption({sortBy:['subject23Count'],sortDesc:['true']})">
...
export default {
  name: 'students_number_subjects_2_3_school',
  ...
  data() {
    return {
      ...
      info: {},
      headers: [
        {text: '序号', value: 'id', initHide: true},//initHide
        ...
        {text: '科二在学人数', value: 'subject2Count', initHide: false},
        {text: '科三在学人数', value: 'subject3Count', initHide: false},
        {text: '科二科三总人/次数', value: 'subject23Count', initHide: false},
      ...
      searchSqlType: {
        ...
        dateBetween: ['createTime', 'updateTime','searchDate'],/* 日期范围查询 */
      },
  ...
  beforeRouteEnter(to,from,next){
    if(!to.query.option){next({...to,query: {option: {sortBy:['subject23Count'],sortDesc:['true']}}})
    }else{
      next()
    }
  },
...
<style lang="scss">
#students_number_subjects_2_3_school {
  height: 100%;
