    ...
    <v-sheet elevation="0" color="rgba(255,255,255,0)">
      ...
      <div class="filterToolbar" v-show="filterToolbar">
        ...
        <v-select style="flex: 0 1 200px" outlined dense :menu-props="{ offsetY: true }"
                  :items="[{text:'科二',value:'2'},{text:'科三',value:'3'}]" v-model="searchOption.statusSubject" clearable
      ...
      <v-data-table elevation="1" class="userTable dataTable" fixed-header multi-sort show-select
        ...
        <template v-slot:[`item.status_subject`]="{ item }">
          <v-chip color="primary" v-if="item.status_subject<3" small label>科目二</v-chip>
          <v-chip color="success" v-else-if="item.status_subject>2" small label>科目三</v-chip>
        </template>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: '暂不考科目', value: 'status_subject',initHide:false},
        ...
        {text: '手机', value: 'phone',initHide:true},//initHide
        {text: '身份证', value: 'id_number',initHide:true},//initHide
        // {text: '地址', value: 'areaCode',initHide:true},
        // {text: '链接', value: 'url',initHide:true},
        // {text: '介绍', value: 'profile',initHide:true},
        {text: '报名日期', value: 'register_date',initHide:true},//initHide
      ...
      searchSqlType: {
        ...
        mySubject: ['statusSubject'],/* 自定义 科二科三范围查询 */
      },
      selectedSchool:null,
      selectedCoach:null,
    }
