<template>
  <div id="coach_students_subject_4">
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: '账号', value: 'username',initHide:true},//initHide
      ...
      searchSqlType: {
        ...
        equal: ['status','noExam','coachId','school.area','school.id','statusSubject'],/* 精确查询 */
