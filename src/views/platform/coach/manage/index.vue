  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: '所属驾校', value: 'school.name', initHide: false},
        {text: '驾校ID', value: 'school.id', initHide: true},
        {text: '驾校地区', value: 'school.area', initHide: false},
        {text: '驾校序号', value: 'school.sort', initHide: true},
        {text: '驾校编号', value: 'school.code', initHide: true},
