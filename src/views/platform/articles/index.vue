  ...
  <div id="articles">
    <v-sheet elevation="0" color="rgba(255,255,255,0)">
      ...
      <v-data-table elevation="1" class="articleTable dataTable" fixed-header multi-sort show-select
        ...
        <template v-slot:top>
          <!--   编辑、新增对话框   -->
          <v-dialog persistent v-model="formDialog" max-width="500px">
            <v-card>
              <v-card-title>
                  ...
                  <v-form :disabled="loadingSubmit">
                    <v-row no-gutters>
                      ...
                      <v-col cols="12">
                        ...
                        <image-uploader-batch-plus v-model="form.cover"/>
                      </v-col><v-spacer/>
                      <!--状态-->
                      <v-col cols="12">
...
import ImageUploaderBatchPlus from "@/components/ImageUploaderBatchPlus"

export default {
  name: 'articles',
  components: {
    ImageUploaderBatchPlus
  },
  data() {
    return {
      type:0,
