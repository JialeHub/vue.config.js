<template>
  <v-app id="layout">
    ...
    <v-navigation-drawer app v-model="navigation" width="230" floating :dark="darkThemeMenu" :light="lightThemeMenu" :mini-variant="miniMenu">
      <drawer-navigation/>
    </v-navigation-drawer>
...
<!--          <router-view class="routerMain"/>-->
          <keep-alive :include="['Home','HomeSchool','HomeCoach']">
            <router-view class="routerMain"/>
          </keep-alive>
        </transition>
      </v-container>
